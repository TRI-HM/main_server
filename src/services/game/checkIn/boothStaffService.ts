import { BoothStaffModelSequelize, BoothStaffModelType } from "../../../models/game/checkIn/boothAcc.model";
import validateFields from "../../../util/validateField";
import { BoothStaffUseCase } from "../../../models/game/checkIn/boothAcc.model";
